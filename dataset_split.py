...
if __name__ =="__main__":
    ...
    train_path = "data/SYNTH_PEDES/synthpedes-dataset-train.json"
    test_path = "data/SYNTH_PEDES/synthpedes-dataset-test.json"
    valid_path = "data/SYNTH_PEDES/synthpedes-dataset-valid.json"
    dataset_path = "data/SYNTH_PEDES/synthpedes-dataset.json"
    TrainValidTest_split(dataset_path, train_path, test_path, valid_path)